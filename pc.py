...
def assign_weight(weight, phase, phase_winner, opt_list, cards):
    ...
    if phase == 1:
        ...
        # highest t3
            ...
            if cards[-2] == "t1":
                ...
                if cards[-3] == "t1":
                    weight = add_weight(weight, opt_list, 0.65, 0.05, 0.30)
                elif cards[-3] == "t2":
                    weight = add_weight(weight, opt_list, 0.54, 0.01, 0.45)
                else:
                    weight = add_weight(weight, opt_list, 0.40, 0.00, 0.60)
    elif phase == 2:
        if phase_winner == "PC":
            if cards[-1] == "t1":
                weight = add_weight(weight, opt_list, 0.30, 0.60, 0.10)
                ...
                if cards[-2] == "t1":
                    ...
                    weight = add_weight(weight, opt_list, 0.50, 0.35, 0.15)
            elif cards[-1] == "t3":
                if cards[-2] == "t1":
                    weight = add_weight(weight, opt_list, 0.70, 0.15, 0.15)
                elif cards[-2] == "t2":
                    weight = add_weight(weight, opt_list, 0.70, 0.10, 0.20)
                else: 
                    weight = add_weight(weight, opt_list, 0.50, 0.00, 0.50)       
        elif phase_winner == "tie":
            if cards[-1] == "t1":
                weight = add_weight(weight, opt_list, 0.10, 0.70, 0.20, "yes")
            elif cards[-1] == "t2":
                if cards[-2] == "t1":
                    weight = add_weight(weight, opt_list, 0.15, 0.60, 0.25, "yes")
                else:
                    weight = add_weight(weight, opt_list, 0.25, 0.50, 0.25)
            elif cards[-1] == "t3":
                if cards[-2] == "t1":
                    weight = add_weight(weight, opt_list, 0.40, 0.30, 0.30)
                elif cards[-2] == "t2":
                    weight = add_weight(weight, opt_list, 0.45, 0.20, 0.35)
                else: 
                    weight = add_weight(weight, opt_list, 0.20, 0.00, 0.80)
        # Player won phase 1
        else:    
            if cards[-1] == "t1":
                weight = add_weight(weight, opt_list, 0.05, 0.90, 0.05, "yes")
            elif cards[-1] == "t2":
                if cards[-2] == "t1":
                    weight = add_weight(weight, opt_list, 0.10, 0.83, 0.07, "yes")
                else:
                    weight = add_weight(weight, opt_list, 0.15, 0.75, 0.10)
            elif cards[-1] == "t3":
                if cards[-2] == "t1":
                    weight = add_weight(weight, opt_list, 0.40, 0.40, 0.20)
                elif cards[-2] == "t2":
                    weight = add_weight(weight, opt_list, 0.45, 0.20, 0.35)
                else: 
                    weight = add_weight(weight, opt_list, 0.60, 0.05, 0.35)       
    elif phase == 3:
        if phase_winner == "PC":
            if cards[0] == "t1":
                weight = add_weight(weight, opt_list, 0.05, 0.40, 0.55, "yes")
            elif cards[0] == "t2":
                weight = add_weight(weight, opt_list, 0.20, 0.20, 0.60)
            else:
                weight = add_weight(weight, opt_list, 0.09, 0.01, 0.90)
        elif phase_winner == "tie":
            if cards[0] == "t1":
                weight = add_weight(weight, opt_list, 0.05, 0.50, 0.45, "yes")
            elif cards[0] == "t2":
                weight = add_weight(weight, opt_list, 0.20, 0.20, 0.60)
            else:
                weight = add_weight(weight, opt_list, 0.10, 0.05, 0.85)
        # Player won first row
        else:
            if cards[0] == "t1":
                weight = add_weight(weight, opt_list, 0.05, 0.90, 0.05, "yes")
            elif cards[0] == "t2":
                weight = add_weight(weight, opt_list, 0.20, 0.50, 0.30)
            else:
                weight = add_weight(weight, opt_list, 0.45, 0.10, 0.45) 
    return weight
